...
import { updateProfileSchema, addVehicleSchema, updateVehicleSchema } from './user.schema';
...
router.patch('/vehicles/:vehicleId', validate(updateVehicleSchema), ctrl.updateVehicle);
